...
const CategoryDescriptions = () => {
  return (
    <div className="mx-auto mt-10 mb-10 md:my-0 lg:mb-11 lg:mt-0 w-[80vw] md:w-[75vw] lg:w-250 lg:max-w-[80vw] h-[55vh] md:h-[66vh] lg:h-[60vh] justify-center items-center md:py-[5vh] px-5">
      
        <Carousel
        //  className='flex justify-center items-center'
        >

            <CarouselContent className='flex gap-8 mt-1 lg:gap-5 pl-5 pr-1 md:px-5 w-[75vw] md:w-[61vw] h-[50vh] -ml-4 lg:-ml-2'>
